...
export const MAX_NON_IMAGE_AI_REQUESTS_PER_UTC_DAY = 100;
export const MAX_IMAGE_GENERATIONS_PER_UTC_DAY = 20;
export const MAX_IMAGE_GENERATIONS_PER_RECORDING = 5;
...
export const IMAGE_OPENAI_REQUEST_TIMEOUT_MILLISECONDS = 120_000;
export const GENERATION_DEADLINE_MILLISECONDS = 30 * 60 * 1000;
